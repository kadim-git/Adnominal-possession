			...
			<table id="StrategyNominTable">
				...
				<tr class="StrategyPronomHeaderRow">
					<xsl:for-each select="$StrategiesSet">
						...
						<td>
							...
							<xsl:if test="PronStrategy/@refStrategyID">
								<span class="attrNameValue">
									Pronominal Strategy ID=
									<span class="attrValue">
										<xsl:value-of select="PronStrategy/@refStrategyID" />
									</span>
								</span>

							</xsl:if>
						<!--	<xsl:if test="not (PronStrategy/@refStrategyID or @Complexity) ">
								<br />
							</xsl:if>-->
						...
						<td>
							...
							<xsl:if test="Morphology/Pronoun">
								...
								<span class="attrNameValue">
									...
									<span class="attrValue">
										<xsl:value-of select="Morphology/Pronoun/@Dedicated" />
									</span>
								</span>
								<br />
								<span class="attrNameValue">
								...
								<span class="attrNameValue">
									...
									<span class="attrValue">
										...
										<xsl:value-of select="Morphology/Pronoun/@AttachmentSite" />
									</span>
								</span>
				...
				<tr class="MorphRow">
					...
					<xsl:for-each select="$StrategiesSet">
						...
						<td>
							<xsl:apply-templates select="Morphology/Morpheme" />
			...
			<table id="StrategyPronomTable">
				...
				<tr class="StrategyPronomHeaderRow">
					<xsl:for-each select="$StrategiesSet">
						...
						<td>
							<xsl:if test="self::StrategyPronomNonCanonical | self::StrategyPronom">
							<!--	<span class="attrNameValue">
									Complexity=
									<span class="attrValue">
										<xsl:value-of select="@Complexity" />
